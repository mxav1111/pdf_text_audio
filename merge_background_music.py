...
exec_os_command = (
    ...
    + ' -lavfi "[1:a]volume=0.1,apad[A];[0:a][A]amerge[out]" -map [out]:a -shortest -b:a 192k '
    + audio_filenameext
)
print(
    f"Merging {voice_audio_filename} and {background_audio_filename} : {audio_filenameext} \n using: {exec_os_command}"
)
